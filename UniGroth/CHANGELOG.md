...
**RESEARCH PROTOTYPE** : This release contains the baseline Groth16 implementation. Universal setup, SAP arithmetization, folding, and other UniGroth features are under active development.
